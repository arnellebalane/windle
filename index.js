(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    function ie(e, s) {
      var t,
        ...
        o = e.__data__;
      return (
        'string' == (n = a((t = s))) || 'number' == n || 'symbol' == n || 'boolean' == n
          ? '__proto__' !== t
          : null === t
      )
      ...
      for (var d in e)
        (!a && !na.call(e, d)) ||
          (r &&
            ('length' == d ||
              (n && ('offset' == d || 'parent' == d)) ||
              (o && ('buffer' == d || 'byteLength' == d || 'byteOffset' == d)) ||
              ta(d, l))) ||
          i.push(d);
      return i;
    }
    ...
    function Za(e) {
      var a = e.isWin,
        ...
        n = Xa();
      a
        ? ((n.guesses[t] += 1), s ? (n.currentStreak += 1) : (n.currentStreak = 1))
              ...
              value: function () {
                ...
                this.$game.addEventListener('game-key-press', function (e) {
                  ...
                  '←' === a || 'Backspace' === a
                    ...
                    : '↵' === a || 'Enter' === a
                    ? d.submitGuess()
                    : Wa.includes(a.toLowerCase()) && d.addLetter(a.toLowerCase());
                }),
                ...
                this.shadowRoot.appendChild(ys.content.cloneNode(!0)),
                  ...
                  window.addEventListener('keydown', function (a) {
                    if (!0 !== a.repeat) {
                      ...
                      t ||
                        n ||
                        ((Wa.includes(s.toLowerCase()) || 'Backspace' === s || 'Enter' === s) &&
                  ...
                  fs.forEach(function (a) {
                    ...
                    s.classList.add('row'),
                      a.forEach(function (e) {
                        ...
                        if ((e >= 'a' && e <= 'z') || '←' === e || '↵' === e) {
                          if (
                            (((a = gs.content.cloneNode(!0).firstElementChild).dataset.key = e),
                            (a.textContent = e),
                            '←' === e)
                          ) {
  ...
  ***************************************************************************** */
            ...
            for (; r; )
              try {
                if (
                  ((s = 1),
                  t &&
                    (n = 2 & o[0] ? t.return : o[0] ? t.throw || ((n = t.return) && n.call(t), 0) : t.next) &&
                    !(n = n.call(t, o[1])).done)
                )
                  return n;
    ...
    var _s =
        (null === (js = null == Es ? void 0 : Es.write) || void 0 === js || js.bind(Es),
    ...
    var Fs = document.createElement('template'),
      Ws = [
        ...
        { id: 'crossword', name: 'The Crossword', url: '/crosswords/game/daily', backgroundImage: 'var(--daily)' },
        { id: 'mini', name: 'The Mini', url: '/crosswords/game/mini', backgroundImage: 'var(--mini)' },
        { id: 'tiles', name: 'Tiles', url: '/puzzles/tiles', backgroundImage: 'var(--tiles)' },
        { id: 'sudoku', name: 'Sudoku', url: '/puzzles/sudoku', backgroundImage: 'var(--sudoku)' },
        { id: 'vertex', name: 'Vertex', url: '/puzzles/vertex', backgroundImage: 'var(--vertex)' },
        {
          id: 'letter-boxed',
          name: 'Letter Boxed',
              ...
              this.shadowRoot.appendChild(Us.content.cloneNode(!0)),
                ...
                this.shadowRoot.addEventListener('animationend', function (a) {
                  'SlideLeft' === a.animationName &&
                    (e.shadowRoot.querySelector('.content-nav').classList.remove('closing-nav'),
                    e.removeChild(e.firstChild),
                    e.removeAttribute('open'));
                });
            },
